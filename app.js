...
app.use(
    cors({
        origin: [
            ...
            "https://ressourcesrelationnelles.netlify.app/register",
            ...
            "https://ressourcesrelationnelles.herokuapp.com/ressource/ressource",
...
app.post('/upload', upload.single('selectedFile'), (req, res) => {
    ...
    let { title, theme, type, description, privee, categorie } = req.body;
    ...
    cloudinary.uploader.upload(
        ...
        function (err, file) {
            ...
            let poste = addPoste({ title, theme, newDocURL, type, description, privee, categorie });
            res.json(poste);
        }
    )
});
